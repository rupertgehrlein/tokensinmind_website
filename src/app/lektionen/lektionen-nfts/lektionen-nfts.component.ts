...
@Component({
  selector: 'app-lektionen-nfts',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './lektionen-nfts.component.html',
  styleUrl: './lektionen-nfts.component.scss'
})
export class LektionenNftsComponent {
  startTime: number;
  initialTime: number;
  elapsedTime: number;
  userId;
  ...
  updateTimeAndSaveToDatabase() {
    ...
    this.supabaseService.setTime('lektion', 'nft', this.initialTime + this.elapsedTime, this.userId);
  }
  ...
  checkResults() {
    ...
    const correctAnswers = ['NFT', 'austauschbar', 'Blockchain', 'Transaktionen', 'Fußballkarten', 'Non-Fungible Token'];
